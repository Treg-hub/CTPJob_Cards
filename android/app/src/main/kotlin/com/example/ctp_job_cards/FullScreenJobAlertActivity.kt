...
class FullScreenJobAlertActivity : ComponentActivity() {
    ...
    private fun setupUI() {
        ...
        btnAssignSelf.setOnClickListener {
            ...
            // === ALWAYS FETCH CURRENT USER (MOST RELIABLE) ===
            var finalClockNo = ""
            var finalName = "Unknown User"
            ...
            if (finalClockNo.isEmpty()) {
                val prefs = getSharedPreferences("employee_prefs", Context.MODE_PRIVATE)
                finalClockNo = prefs.getString("clockNo", "") ?: ""
                finalName = prefs.getString("employeeName", "Unknown User") ?: "Unknown User"
            }
        ...
        if (shouldShowImBusyButton()) {
            ...
            btnImBusy.setOnClickListener {
                ...
                db.collection("notifications").add(hashMapOf(
                    ...
                    "triggeredBy" to "busy",
                    "initiatedByClockNo" to finalClockNo,
                    "initiatedByName" to finalName,
        ...
        btnDismiss.setOnClickListener {
            ...
            // Log Dismiss action with correct user info
            val db = FirebaseFirestore.getInstance()
            db.collection("notifications").add(hashMapOf(
                "jobCardNumber" to jobCardNumber.toIntOrNull(),
