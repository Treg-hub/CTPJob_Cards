...
- **Startup / Update surfaces (2026-07-03; in-app install + publish + onboarding 2026-07-08)**: Kill-switch + soft UpdateService (RC then settings/app publish fields) + ApkInstallService install handoff; WhatsNew multi-build rollup; Admin Publish release form; persona onboarding tracks (security/fleet/ink short path + finish expectations). See JobCardsCoreModule.md.
