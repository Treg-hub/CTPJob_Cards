...
import '../screens/fleet_report_wizard_screen.dart';
...
Future<void> showFleetMachineActionSheet(
  ...
  return showModalBottomSheet<void>(
    context: context,
    useSafeArea: true,
    builder: (ctx) => _FleetMachineActionSheet(asset: asset),
  );
}

class _FleetMachineActionSheet extends StatelessWidget {
  const _FleetMachineActionSheet({required this.asset});
          ...
          FilledButton.icon(
            onPressed: () {
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) =>
                      FleetReportWizardScreen(preSelectedAsset: asset),
                ),
              );
            },
