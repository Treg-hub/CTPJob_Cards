...
- **Automatic In-App Update Checking**: Runs after login on mobile, checks Firestore for latest version, shows update dialog with release notes, supports force updates, daily check throttling, opens download URL
